...
For personal use, deploy without API environment variables. On the live site, open Settings → AI connection and enter your own key, address and model. Choose Connect and test. The connection is remembered in this browser on this device, including after closing and reopening it; use Disconnect and remove key to clear it.
